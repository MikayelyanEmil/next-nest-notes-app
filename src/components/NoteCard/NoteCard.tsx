  ...
  return (
    <div className={styles.notecard} key={id}>
      <div className={styles.top}>
        ...
        <button className={styles.editBtn} onClick={() => handleEdit(id)}><Image src={editIcon} height={18} width={18} /></button>
        <button className={styles.deleteBtn} onClick={() => handleDelete(id)}> <Image src={redDeleteIcon} height={18} width={18} /></button>
      </div>
