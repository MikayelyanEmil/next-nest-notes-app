...
export class AuthController {
  ...
  async create(@Body() createUserDto: CreateUserDto, @Res() res: Response) {
    ...
    res.cookie('refresh_token', refresh_token, { maxAge: 30 * 24 * 60 * 60 * 1000, httpOnly: true, sameSite: "none", secure: true });
    res.cookie('user_id', user.id, { maxAge: 30 * 24 * 60 * 60 * 1000, httpOnly: true, sameSite: "none", secure: true });
