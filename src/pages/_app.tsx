...
export default function App({ Component, pageProps }: AppProps) {
  ...
  return <Layout isAuthorized={isAuthorized} setIsAuthorized={setIsAuthorized} loading={loading} setLoading={setLoading} signup={signup} showSignup={showSignup} user={user} setUser={setUser} setBody={setBody}>
    <Component {...pageProps} />
  </Layout>
